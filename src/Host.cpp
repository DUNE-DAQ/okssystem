...
std::string
OksSystem::Host::resolve(struct sockaddr_in address) throw()
{
...
std::string
OksSystem::Host::expand(const std::string& name) throw()
{
...
std::string
OksSystem::Host::to_string(struct sockaddr_in ip_addr)
{
...
OksSystem::Host::~Host() throw() {} // OksSystem
...
bool
OksSystem::Host::equals(const Host& other) const throw()
{
...
const std::string&
OksSystem::Host::name() const throw()
{
  return m_name;
}
...
struct sockaddr_in
OksSystem::Host::ip() const throw()
{
  return resolve(m_name);
}
...
const std::string&
OksSystem::Host::full_name() const throw()
{
...
std::string
OksSystem::Host::ip_string() const throw()
{
...
bool
OksSystem::operator==(const Host& a, const Host& b) throw()
{
  return a.equals(b);
} // operator ==
...
const std::string&
OksSystem::LocalHost::local_name() throw()
{
...
const std::string&
OksSystem::LocalHost::full_local_name() throw()
{
...
const OksSystem::LocalHost*
OksSystem::LocalHost::instance() throw()
{
  if (0 == s_instance) {
...
const std::string&
OksSystem::LocalHost::os_name() const throw()
{
  return m_os_name;
} // os_name
...
const std::string&
OksSystem::LocalHost::os_release() const throw()
{
  return m_release;
} // os_release
...
const std::string&
OksSystem::LocalHost::os_version() const throw()
{
  return m_version;
} // os_version
...
const std::string&
OksSystem::LocalHost::machine() const throw()
{
  return m_machine;
} // machine
...
const std::string&
OksSystem::LocalHost::description() const throw()
{
...
bool
OksSystem::operator==(const LocalHost&, const LocalHost&) throw()
{
  return true;
}
...
std::ostream&
operator<<(std::ostream& stream, const OksSystem::Host& host)
{
