...
uid_t
OksSystem::User::identity() const throw()
{
  return m_user_id;
} // identity
...
void
OksSystem::User::resolve_safe() const throw()
{
...
const std::string&
OksSystem::User::name_safe() const throw()
{
  if (m_user_name.empty()) {
    resolve_safe();
  }
...
const std::string&
OksSystem::User::home() const
{
  if (m_user_home.empty()) {
    resolve();
  }
  return m_user_home;
} // home
...
const std::string&
OksSystem::User::real_name() const
{
  if (m_user_real_name.empty()) {
    resolve();
  }
...
std::ostream&
operator<<(std::ostream& stream, const OksSystem::User& user) throw()
{
...
bool
operator==(const OksSystem::User& a, const OksSystem::User& b) throw()
{
