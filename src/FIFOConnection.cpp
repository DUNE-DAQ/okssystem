...
void
OksSystem::FIFOConnection::make(mode_t perm) const
{
  File::make_fifo(perm);
} // make
...
std::string
OksSystem::FIFOConnection::read_message() const
{
...
void
OksSystem::FIFOConnection::send_message(const std::string& message) const
{
...
void
OksSystem::FIFOConnection::send(const std::string& message) const
{
...
std::string
OksSystem::FIFOConnection::read() const
{
  ERS_ASSERT(m_fifo_fd);
  char buffer[MAX_MESSAGE_LEN];
  while (true) {
    ...
    if (m_is_blocking == false && status == 0)
      return std::string("");
...
OksSystem::FIFOConnection::open_r(bool block)
{
...
OksSystem::Descriptor*
OksSystem::FIFOConnection::open_w(bool block)
{
...
OksSystem::Descriptor*
OksSystem::FIFOConnection::open_rw(bool block)
{
...
int
OksSystem::FIFOConnection::fd() const
{
