...
OksSystem::MapFile::MapFile(const std::string& name, size_t s, size_t o, bool read_mode, bool write_mode, mode_t perm)
  : File(name)
{
...
bool
OksSystem::MapFile::is_loaded() const throw()
{
...
void*
OksSystem::MapFile::address() const throw()
{
...
size_t
OksSystem::MapFile::memory_size() const throw()
{
  return m_map_size;
} // memory_size
...
bool
OksSystem::MapFile::is_mapped() const
{
  return m_is_mapped;
}

OksSystem::Descriptor*
OksSystem::MapFile::fd() const throw()
{
