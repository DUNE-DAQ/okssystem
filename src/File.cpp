...
const char* const OksSystem::File::HUMAN_OPEN_STR[] = { "READ",   "WRITE",    "NOBLOCK",  "APPEND",
...
std::string
OksSystem::File::protocol(const std::string& url) throw()
{
...
std::string
OksSystem::File::extension(const std::string& url) throw()
{
...
std::string
OksSystem::File::short_name(const std::string& url) throw()
{
...
std::string
OksSystem::File::uri(const std::string& url) throw()
{
  std::string::size_type colon = url.find(COLON_CHAR);
  if (colon == std::string::npos)
    return url;
...
int
OksSystem::File::depth(const std::string& path) throw()
{
...
std::string
OksSystem::File::first_line(const std::string& text)
{
...
OksSystem::File
OksSystem::File::from_url(const std::string& url)
{
...
std::string
OksSystem::File::working_directory()
{
...
void
OksSystem::File::working_directory(const File& dir)
{
...
std::string
OksSystem::File::expand_home(const std::string path)
{
...
std::string
OksSystem::File::pretty_permissions(mode_t permissions)
{
  char buffer[11];
...
std::string
OksSystem::File::pretty_open_flag(int flags)
{
...
std::string
OksSystem::File::pretty_size(size_t size, bool cut_small)
{
  if (0 == size)
    return "0";
...
bool
OksSystem::File::equals(const File& other) const throw()
{
...
void
OksSystem::File::set_name(const std::string& name)
{
...
const std::string&
OksSystem::File::full_name() const throw()
{
  return m_full_name;
} // full_name
...
const char*
OksSystem::File::c_full_name() const throw()
{
  return m_full_name.c_str();
} // c_full_name
...
std::string
OksSystem::File::short_name() const throw()
{
...
std::string
OksSystem::File::parent_name() const throw()
{
...
std::string
OksSystem::File::extension() const throw()
{
  return extension(m_full_name);
} // extension

int
OksSystem::File::depth() const throw()
{
...
bool
OksSystem::File::exists() const throw()
{
...
mode_t
OksSystem::File::permissions() const
{
...
std::string
OksSystem::File::pretty_permissions() const
{
...
std::string
OksSystem::File::to_string(mode_t permissions) throw()
{
...
bool
OksSystem::File::is_regular() const
{
...
bool
OksSystem::File::is_directory() const
{
  const mode_t mode = get_mode();
  return (mode & S_IFDIR);
} // is_regular
...
std::string
OksSystem::File::file_type() const
{
...
OksSystem::File::file_list_t
OksSystem::File::directory() const
{
...
void
OksSystem::File::rename(const File& other) const
{
...
void
OksSystem::File::permissions(mode_t perm) const
{
  if (perm != permissions()) {
...
void
OksSystem::File::make_dir(mode_t perm) const
{
...
void
OksSystem::File::make_path(mode_t perm) const
{
...
void
OksSystem::File::ensure_path(mode_t perm) const
{
  const File father = parent();
...
void
OksSystem::File::make_fifo(mode_t perm) const
{
  if (exists()) {
    if (is_fifo()) {
      if (perm != permissions()) {
...
std::ostream*
OksSystem::File::output(bool append) const
{
  try {
...
std::ostream&
operator<<(std::ostream& stream, const OksSystem::File& file)
{
...
bool
operator==(const OksSystem::File& a, const OksSystem::File& b) throw()
{
  return a.equals(b);
} // operator ==
