...
void
OksSystem::Environment::set(const std::string& key, const std::string& value)
{
...
void
OksSystem::Environment::set(const std::map<std::string, std::string>& values)
{
...
std::string
OksSystem::Environment::get(const std::string& key)
{
