...
OksSystem::StringMemoryArea::add(const char* str)
{
...
size_t
OksSystem::StringMemoryArea::clear(offset_t offset)
{
  char* data = string_area_write();
  size_t count = 0;
...
const char*
OksSystem::StringMemoryArea::get_string(offset_t offset) const
{
  if (offset == 0)
    return 0;
...
OksSystem::StringMemoryArea::offset_t
OksSystem::StringMemoryArea::insert(offset_t offset, const char* str)
{
  ERS_PRECONDITION(str);
  if (offset == 0)
    return add(str);
...
OksSystem::StringMemoryArea::get_vector(offset_t offset) const
{
...
OksSystem::StringMemoryArea::offset_t
OksSystem::StringMemoryArea::insert(offset_t offset, const str_vector& vect)
{
...
OksSystem::StringMemoryArea::get_map(offset_t offset) const
{
...
OksSystem::StringMemoryArea::offset_t
OksSystem::StringMemoryArea::insert(offset_t offset, const str_map& map)
{
  //    ERS_RANGE_CHECK(0, offset, string_area_size());
