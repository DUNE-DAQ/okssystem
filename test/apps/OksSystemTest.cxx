...
void
test_write_chmod(const OksSystem::File& file)
{
  ...
  TLOG_DEBUG(1) << "Setting permissions: " << OksSystem::File::pretty_permissions(permission).c_str() << " "
                << permission;
...
int
test_exec(const OksSystem::Executable& executable, int status)
{
...
void
test_map_file(const OksSystem::File& file)
{
...
void
test_mkdir(const OksSystem::File& file)
{
...
void
test_rmdir(const OksSystem::File& file)
{
...
void
test_delete_file(const OksSystem::File& file)
{
...
void
test_path(const OksSystem::Path& path, const std::string& name)
{
