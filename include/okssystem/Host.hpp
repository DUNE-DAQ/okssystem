...
bool
operator==(const Host& a, const Host& b) throw(); ///< \brief equality operator
bool
operator!=(const Host& a, const Host& b) throw(); ///< \brief inequality operator
...
const char*
getfullhost() throw(); ///< \brief get fully qualified host name

bool
operator==(const LocalHost& a, const LocalHost& b) throw();
bool
operator!=(const LocalHost& a, const LocalHost& b) throw();
